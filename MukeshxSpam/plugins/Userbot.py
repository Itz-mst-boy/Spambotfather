...
RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/aafe899afdbd00314a561.jpg"


rizoel = "✧ ᴍᴜᴋᴇsʜ x sᴘᴀᴍ ʜᴇʀᴇ ✧\n\n"
...
rizoel += f"┣➣ **sᴜᴘᴘᴏʀᴛ** : [JOIN](https://t.me/cbseclass10mcqs)\n"
...
RiZoeLX += f"© @itz_mst_boy | @mr_sukkun\n"
