RAID = [
    ...
    "TERI MUMMY KI FANTASY H🍆🍆U LAWDE, TU APNI BHEN KO SMBHAAL 😈😈",
...
REPLYRAID = [
    "MADARCHOD",
    "BHOSDIKE MR HACKER TOHAR BAAP HAI",
    "TOHAR BUR ME PILUA PHARTO HAMAR SARAP PARTO RE" ,
    "MAI KA BUR BECHEGA OLX PAR",
    "LAAAWEEE KE BAAAAAL",
